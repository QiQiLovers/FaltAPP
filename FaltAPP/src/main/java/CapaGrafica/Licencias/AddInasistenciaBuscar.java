...
import CapaGrafica.LoginAdmin;

/**
 *
 * @author tomas
 */
public class AddInasistenciaBuscar extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AddInasistenciaBuscar.class.getName());

    /**
     * Creates new form AddLicencia
     */
    public AddInasistenciaBuscar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingresa la cedula del docente");
        ...
        CI_Ingresar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CI_IngresarActionPerformed(evt);
            }
        });
        ...
        Ingresar_BTN.setBackground(new java.awt.Color(77, 130, 244));
    ...
    private void CI_IngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CI_IngresarActionPerformed
    ...
    private void Ingresar_BTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ingresar_BTNActionPerformed
        // TODO add your handling code here:
        AddInasistencia_AniadirDatos Ina=new AddInasistencia_AniadirDatos();
        dispose();
        setVisible(false);
        Ina.setVisible(true);
    ...
    private void Cancelar_BTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Cancelar_BTNActionPerformed
        // TODO add your handling code here:
        ControlesAdmin neo= new ControlesAdmin();
        dispose();
        setVisible(false);
        neo.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AddInasistenciaBuscar().setVisible(true));
    }
