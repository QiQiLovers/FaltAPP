 ...
 * @author tomas
 */
public class ModLicenciaBuscar extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ModLicenciaBuscar.class.getName());

    /**
     * Creates new form AddLicencia
     */
    public ModLicenciaBuscar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificar Licencia -- Buscar Licencia");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ModLicenciaBuscar().setVisible(true));
    }
